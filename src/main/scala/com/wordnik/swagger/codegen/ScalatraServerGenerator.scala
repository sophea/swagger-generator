...
object ScalatraServerGenerator extends ScalatraServerGenerator {
  def main(args: Array[String]) = generateClient(args)
}

class ScalatraServerGenerator extends BasicScalaGenerator {
  override def templateDir = "scalatra/templates"
  ...
  override def apiPackage: Option[String] = Some("apis")
